...
<head>
    <meta charset="UTF-8">
    <title>Pedido #<?php echo htmlspecialchars($pedido['id_pedido']); ?></title>
    <style>
...
<body>
    <div class="titulo">Detalle del Pedido #<?php echo htmlspecialchars($pedido['id_pedido']); ?></div>
    <div><b>Cliente:</b> <?php echo htmlspecialchars($pedido['nombre_usuario'] ?? '-'); ?></div>
    <div><b>Email:</b> <?php echo htmlspecialchars($pedido['email_usuario'] ?? '-'); ?></div>
    <div><b>Fecha:</b> <?php echo htmlspecialchars($pedido['fecha']); ?></div>
    <div><b>Estado:</b> <?php echo htmlspecialchars($pedido['estado']); ?></div>
    <table class="tabla">
        <thead>
            <tr>
                <th>Producto</th>
