<div id="modal_agregar_ingreso" class="fixed inset-0 hidden overflow-y-auto h-full w-full z-30">
    <div class="relative top-20 mx-auto p-5 border w-[800px] shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <form id="formAgregarIngreso" action="index.php?controller=ingreso&action=registrar" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="id_producto" name="id_producto" class="mt-1 block w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none transition duration-150 ease-in-out shadow-sm px-3 py-2 bg-gray-50" required>
                            ...
                            <?php foreach ($productos as $prod): ?>
                                <?php $nombre = htmlspecialchars($prod['nombre_producto']); $talla = htmlspecialchars($prod['talla_producto']); $texto = $nombre . ($talla ? ' - Talla: ' . $talla : ''); ?>
                                <option value="<?php echo $prod['id_producto']; ?>"><?php echo $texto; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="mb-4">
